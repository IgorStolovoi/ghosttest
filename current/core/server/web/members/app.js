...
const socialNetworkAuthRouters = require("../social-networks-auth");
...
module.exports = function setupMembersApp() {
  ...
  // membersApp.get("/api/linkedInSession", middleware.getIdentityToken);
  ...
  //   // socialNetworkAuthRouters.linkedin()
  //   (req, res) => {
  //     res.json({ auth_error: req.query.error, auth_action: req.query.action });
  //   }
  // );
  ...
  membersApp.use(
    ...
    middleware.loadMemberSession,
    // middleware.authMemberByUuid,
    socialNetworkAuthRouters.google()
  );
  membersApp.use(
    "/api/auth/facebook",
    middleware.loadMemberSession,
    // middleware.authMemberByUuid,
    socialNetworkAuthRouters.facebook()
  );

  // membersApp.get(
  //   "/api/auth/linkednetworks",
  //   http(api.authLinkedSocialNetworks.getLinkedNetworks)
  // );

  // membersApp.post(
  //   "/api/auth/unlink",
  //   http(api.authLinkedSocialNetworks.unlinkSocialNetwork)
  // );
